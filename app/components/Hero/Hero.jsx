...
export default function Hero() {
    ...
    return (        
        isLoading ? (
            ...
            <section className="hero flex flex-wrap xl:flex-nowrap justify-center w-screen h-screen">
                <div className="hero-content p-4 overflow-hidden w-full">
                    <motion.div 
                        ...
                        className="heading w-full xl:w-auto xl:h-full md:px-8 flex justify-start items-end mb-4 mt-24 xl:mt-0">
                            <h1 className="text-6xl md:text-[100px] lg:text-[150px] xl:text-[200px] leading-none xl:leading-[160px] font-bold">
                                Emmanuel<br /> Perez
                            </h1>
                    </motion.div>   
                </div>
                <aside className="sidebar xl:min-w-[600px] md:w-full lg:w-full xl:w-[600px] h-auto overflow-y-auto p-4">
                    <div className="sidebar-scroll">
                        <motion.div 
                            ...
                            className="featured-work flex flex-col gap-4 float-right w-full my-24 "
                        >
